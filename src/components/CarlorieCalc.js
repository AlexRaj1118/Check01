...
import UserDetails from './stateless-components/userDetails';
import HistoryNavigator from './stateless-components/historyNavigator';
import Calories from './stateless-components/calories';
import DailyFoodList from './stateless-components/dailyFoodList';

import DataPoints from '../assets/mockData/dataPoints';
import './CarlorieCalc.css';
